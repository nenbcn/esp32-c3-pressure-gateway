...
> - **Procesamiento de señal de presión:** `pressure_signal_specs.md` (arquitectura de colas, algoritmo, estructuras de datos)
> - **Parámetros configurables:** `signal_parameters.h`
...
> **📋 Nota:** Para módulos específicos de procesamiento de presión (Pressure Reader, Telemetry, Message Formatter), ver `pressure_signal_specs.md`
